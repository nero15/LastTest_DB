...
/**
 * Created by mykola on 09.12.15.
 */
public class DrawWay {
    GoogleMap map;
    public DrawWay(GoogleMap map, LatLng origin, LatLng dest){
        this.map = map;
        // Getting URL to the Google Directions API
        String url = getDirectionsUrl(origin, dest, "driving");
    ...
    private String downloadUrl(String strUrl) throws IOException {
        ...
        try {
            ...
            Log.d("Exception ourl", e.toString());
        } finally {
            iStream.close();
